...
Please see our technical [documentation](https://documentation.wazuh.com/index.html) to learn more about its features. For additional help with the plugin, including questions about opening an issue, try the Wazuh [Community](https://wazuh.com/community/).
